    ...
    <>
      ...
      <div className="navbar bg-base-200 shadow-sm">
        <div className="navbar-start">
          <a className="btn btn-ghost text-xl">TechKraft</a>
        </div>
        <div className="navbar-end">
          <div className="dropdown dropdown-end">
            ...
            >
              <li className="menu-label text-xs opacity-50 px-3 py-1">
                {user?.email}
              </li>
              <li>
      ...
      <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-8 mt-8">
        <aside>
          <p>TechKraft Candidate Score &copy; {new Date().getFullYear()}</p>
        </aside>
      </footer>
    </>
  );
