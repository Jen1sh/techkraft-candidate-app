          ...
          <div className="card-body gap-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
              ...
              <label className="input">
                ...
                <input id="name" type="text" className="grow" placeholder="Your full name" {...register("name")} />
              </label>
              ...
              <label className="input">
                ...
                <input id="reg-email" type="email" className="grow" placeholder="you@example.com" {...register("email")} />
              </label>
